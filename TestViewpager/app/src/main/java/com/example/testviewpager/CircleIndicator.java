...
public class CircleIndicator extends LinearLayout {
    ...
    private int mIndicatorBackgroundResId = R.drawable.shape_redcorner;
    private int mIndicatorUnselectedBackgroundResId = R.drawable.shape_blackcorner;
    ...
    public void configureIndicator(int indicatorWidth, int indicatorHeight,
        ...
        configureIndicator(indicatorWidth, indicatorHeight, indicatorMargin,
                R.animator.scale_with_alpha, 0, R.drawable.shape_redcorner,
                R.drawable.shape_blackcorner);
    }
    ...
    private void checkIndicatorConfig(Context context) {
        ...
        mIndicatorHeight = (mIndicatorHeight < 0) ? dip2px(DEFAULT_INDICATOR_WIDTH)
                : mIndicatorHeight;
        mIndicatorMargin = (mIndicatorMargin < 0) ? dip2px(DEFAULT_INDICATOR_MARGIN)
                : mIndicatorMargin;
    ...
    private Animator createAnimatorIn(Context context) {
        ...
        if (mAnimatorReverseResId == 0) {
            ...
            animatorIn = AnimatorInflater.loadAnimator(context,
    ...
    private final OnPageChangeListener mInternalPageChangeListener = new OnPageChangeListener() {
        ...
        public void onPageSelected(int position) {
            ...
            if (mLastPosition >= 0) {
                View currentIndicator = getChildAt(mLastPosition % mCount);
                currentIndicator
            ...
            View selectedIndicator = getChildAt(position % mCount);
